...
func Login(value string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if value == "fail" {
			templ_7745c5c3_Err = components.LoginForm(true).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else if value == "success" {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<p>Login successful.</p>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
